...
public class WobbleViscous : MonoBehaviour
{
    ...
    public float MaxWobble = 0.03f; //Furtherst angle in wobble. Increase to make more watery, decrease to make more jelly.
    public float WobbleSpeed = 0.0003f; //Viscosity adjustment. Increase to move faster
    public float Recovery = 500f; //Viscosity adjustment. Increase to recover faster.
    ...
    float time = 0.5f; ///Used to record delta time.
